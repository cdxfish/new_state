 ...
 */
odoo.define("patrol_widget", function (require) {
    "use strict";
    ...
    var patrol_widget = AbstractField.extend({
            ...
            if (mode == "edit") {
                ...
                self
                    ._rpc({
                        model: model,
                        method: "search_read",
                        domain: [['patrol_node_imange', "=", self.res_id]]
                    })
                    .then(function (data) {
                        if (data) {
                            console.log(data);
                            var $el = $(
                                '<div class="patrol_widget" style="display: flex; flex-wrap: wrap; justify-content: flex-start"></div>'
                            );
                            for (var i in data) {
    ...
    registry.add("patrol_widget", patrol_widget);
    return {patrol_widget: patrol_widget};
});