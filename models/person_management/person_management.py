...
class MainModel(models.Model):
    ...
    # jobnumber = fields.Char(related='staff_basic_information.jobnumber', string='工号')
    ...
    # 员工基础信息
    # staff_basic_information = fields.One2many('cdtct_dingtalk.cdtct_dingtalk_users','relevance',string='员工基础信息')
    # 员工企业信息
    # staff_business_information = fields.One2many('cdtct_dingtalk.cdtct_dingtalk_users','relevance',string='员工企业信息')
    #持证信息
